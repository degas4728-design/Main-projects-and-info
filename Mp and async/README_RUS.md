...
1. **Симуляция экзамена** – многопроцессное приложение, моделирующее приём экзамена несколькими экзаменаторами с учётом обедов, вероятностных ответов и динамического вывода в консоль.
2. **Асинхронный загрузчик изображений** – консольный инструмент для параллельной загрузки картинок по ссылкам с обработкой ошибок и итоговой сводкой.

В коде применяются:
- Объектно-ориентированный (ООП)
- Процедурный
- Функциональный
- Мультипарадигмальный (смешанный) подходы
- Многопроцессорность и асинхронность (asyncio/aiohttp)
- 
### Темы для изучения:
